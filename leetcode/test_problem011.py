...
class TestProblem(object):
    ...
    def test_container_most_water(self, test_data, expected):
        assert Problem011().container_most_water(test_data) == expected
    ...
    def test_container_most_water_linear(self, test_data, expected):
        assert Problem011().container_most_water_linear(test_data) == expected
    ...
    def test_calculate_area(self, height1, height2, distance, expected):
        assert Problem011().calculate_area(height1, height2, distance) == expected
